...
$stid = oci_parse($conn, "select District_id,name,Status, email,voter_id,status from voter where voter_id=$vtid"); 
oci_execute($stid);

while (oci_fetch($stid)) {
    echo "Name:".oci_result($stid, 'NAME') . " <br> ";
    echo "District id:".oci_result($stid, 'DISTRICT_ID') . " <br> ";
    echo "Voting Status:".oci_result($stid, 'STATUS') . " <br> ";
    echo "Email:".oci_result($stid, 'EMAIL') . " <br> ";
    echo "Voter ID:".oci_result($stid, 'VOTER_ID') . " <br> ";
