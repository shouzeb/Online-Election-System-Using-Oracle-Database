...
$id=$_SESSION['did'];
$stid = oci_parse($conn, "SELECT Candidate_id,name,Description,gender,party_id,votes FROM Candidate where district_id=$id");
oci_execute($stid);

echo "<table border='3'  style = 'color:white; width:100%;'><td>Candidate ID</td><td>NAME</td><td>Description</td><td>Gender</td><td>Party ID</td><td>Votes</td>\n";
